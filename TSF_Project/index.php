...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/user.png" class="img-fluid pt-2">
                    <br>
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="transfermoney.php"><button>Monetary Transactions</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2022. Made by <b>Mehta Jainil  Email: jainil22@xyz.com</b>
      </footer>
